...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  9 14:50:43 2020
...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 23 14:38:37 2019
...
import logging
logger = logging.getLogger("VehicleRoutingMain")
...
#        )
    ...
    if assignment:
        ...
        print("Solution count: ", collector.SolutionCount())
        for index in range(collector.SolutionCount()):
            logger.info("Solution index:", index)
            print("Solution index:", index)
            print_solution(data, manager, routing, collector.Solution(index))
            print("-------------------------------------------")
        logger.info('Final solution:')
        print("Final Solution")
        print_solution(data, manager, routing, assignment)
    else:
        raise print("No solution found")
