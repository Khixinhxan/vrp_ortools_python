...
# -*- coding: utf-8 -*-
"""
Created on Thu May 14 13:57:58 2020
...
def print_solution(data, manager, routing, solution):
    ...
    print('Test Output Route by Gateway Capacity in depot')
...
#    list_number_vehicles_used = []
#    for vehicle_id in range(data['num_vehicles']):
#        index = routing.Start(vehicle_id)
#        next_index = routing.Value(
#            routing.NextVar(index))
#        if not (routing.IsStart(index) and
#                routing.IsEnd(next_index)):
#            list_number_vehicles_used.append(vehicle_id)
#    print(list_number_vehicles_used) 
    print(solver)
    print(routing.vehicles())
